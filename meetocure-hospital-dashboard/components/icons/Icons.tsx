...
// Used for Sidebar Brand and Login Page Logo for consistency
...
export const BrandIcon = MedicalCrossIcon;
export const MeetoCureLogoIcon = MedicalCrossIcon;
...
export const AppointmentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export const DoctorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
     <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm0 11v-5.5m0 0a5 5 0 00-5 5v2h10v-2a5 5 0 00-5-5z" />
    </svg>
);

export const PatientIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export const UserCircleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 4c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 10.2c-2.33 0-6.44 1.17-6.44 3.53v.27h12.88v-.27c0-2.36-4.11-3.53-6.44-3.53z" clipRule="evenodd"/>
    </svg>
);
